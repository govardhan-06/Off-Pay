    ...
    uint8_t *pk, uint8_t *sk)
{
    ...
    Zf(i_shake256_init)(&rng);
    Zf(i_shake256_inject)(&rng, seed, sizeof seed);
    Zf(i_shake256_flip)(&rng);
    Zf(keygen)(&rng, f, g, F, NULL, h, 9, tmp.b);
    // Zf(i_shake256_ctx_release)(&rng);
        ...
        const uint8_t *m, size_t mlen, const uint8_t *sk)
{
    ...
    Zf(i_shake256_inject)(&sc, nonce, NONCELEN);
    Zf(i_shake256_inject)(&sc, m, mlen);
    Zf(i_shake256_flip)(&sc);
    Zf(hash_to_point_ct)(&sc, r.hm, 9, tmp.b);
    // Zf(i_shake256_ctx_release)(&sc);
    ...
    randombytes(seed, sizeof seed);
    Zf(i_shake256_init)(&sc);
    Zf(i_shake256_inject)(&sc, seed, sizeof seed);
    Zf(i_shake256_flip)(&sc);
    ...
    v = Zf(comp_encode)(sigbuf, *sigbuflen, r.sig, 9);
    if (v != 0)
    {
        // Zf(i_shake256_ctx_release)(&sc);
        *sigbuflen = v;
    ...
    const uint8_t *m, size_t mlen, const uint8_t *pk)
{
    ...
    if (Zf(modq_decode)(h, 9, pk + 1, PQCLEAN_FALCON512_CLEAN_CRYPTO_PUBLICKEYBYTES - 1) != PQCLEAN_FALCON512_CLEAN_CRYPTO_PUBLICKEYBYTES - 1)
    {
        return -1;
    }
    Zf(to_ntt_monty)(h, 9);
    ...
    v = Zf(comp_decode)(sig, 9, sigbuf, sigbuflen);
    if (v == 0)
    {
        return -1;
    }
    ...
    Zf(i_shake256_inject)(&sc, m, mlen);
    Zf(i_shake256_flip)(&sc);
    Zf(hash_to_point_ct)(&sc, hm, 9, tmp.b);
    // Zf(i_shake256_ctx_release)(&sc);
